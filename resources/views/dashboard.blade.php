            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="col-span-2">
                    <div x-data="{ selectedChart: 'chart1' }" class="flex flex-col ">
                        ...
                        <div class="flex items-center col-span-1 gap-1 mt-2 whitespace-nowrap break-keep ">
                    ...
                    <div class="flex gap-2 mt-8">
                        <div class="flex flex-col w-1/4 p-8 bg-white rounded-lg">
                            <div class="flex items-center justify-center w-10 h-10 p-2 mb-4 bg-blue-100 rounded-full">
                        ...
                        <div class="flex flex-col w-1/4 p-8 bg-white rounded-lg">
                            <div class="flex items-center justify-center w-10 h-10 p-2 mb-4 bg-red-100 rounded-full">
                        ...
                        <div class="flex flex-col w-1/4 p-8 bg-white rounded-lg">
                            <div class="flex items-center justify-center w-10 h-10 p-2 mb-4 bg-green-100 rounded-full">
                        ...
                        <div class="flex flex-col w-1/4 p-8 bg-white rounded-lg">
                            <div class="flex items-center justify-center w-10 h-10 p-2 mb-4 bg-purple-100 rounded-full">
